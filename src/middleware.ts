...
export const config = {
  matcher: [
    '/((?!_next/static|_next/image|favicon.ico|login|register|warning|api/login|api/register|api/logout|api/cron|api/server-config|api/tvbox|api/proxy|api/live/merged|api/parse|api/bing-wallpaper|api/proxy/spider.jar|api/telegram/).*)',
    '/adult/:path*',
  ],
};
